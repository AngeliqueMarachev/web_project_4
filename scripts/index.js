...
const addCardModalCloseButton = document.querySelector(".popup__close_add-card");
...
const descriptionInputValue = editForm.querySelector(".popup__input_type_occupation"); 
